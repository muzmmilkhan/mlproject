...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """"This method creates a data transformation pipeline that includes both numerical and categorical transformations."""
        try:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """This method initiates the data transformation process by loading the data, applying transformations, and saving the preprocessor object."""
        try:
